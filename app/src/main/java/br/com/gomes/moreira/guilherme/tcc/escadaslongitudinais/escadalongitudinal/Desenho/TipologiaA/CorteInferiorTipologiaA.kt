...
class CorteInferiorTipologiaA : DesenhoCorte(ESCADA) {
    //Desenhos
    //Desenho Geral
    ...
    override fun contornoPath(xBase: Float, yBase: Float): Path {
        ...
        val comprimentoLanceInferior = comprimentoLance + piso
    ...
    override fun armaduraPositivaPrincipalInicialPath(xBase: Float, yBase: Float): Path {
        return this.armaduraPositivaPrincipal.barraInicialInferior.geometriaPerfilPath(xBase, yBase)
    }
    ...
    override fun anguloTextoArmaduraPositivaSecundariaLance(): Float {
        return (toDegrees(anguloLanceNegativo.toDouble())).toFloat()
    }
