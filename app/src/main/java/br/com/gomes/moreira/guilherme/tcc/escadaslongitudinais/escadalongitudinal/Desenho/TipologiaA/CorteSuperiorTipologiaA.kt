...
class CorteSuperiorTipologiaA : DesenhoCorte(Escada.ESCADA) {
    //Desenhos
    //Desenho Geral
    override fun desenharCorte(xBase: Float,
        ...
        //Coordenadas Armadura Negativa Patamar Intermediario
    ...
    override fun contornoPath(xBase: Float, yBase: Float): Path {
        ...
        val comprimentoLanceInferior = comprimentoLance - delta + delta2

        val comprimentoSuperiorPatamarIntermediario = comprimentoPatamarIntermediario + baseApoioDireito
        val comprimentoInferiorPatamarIntermediario = comprimentoPatamarIntermediario + delta
        ...
        contornoPath.apply {
            ...
            rLineTo(-comprimentoLanceInferior, - desnivelPorLance)
    ...
    override fun posicaoTextosArmaduraPositivaPrincipalFinal(xBase: Float, yBase: Float): List<PointF> {
        return armaduraPositivaPrincipal.barraFinalSuperior.posicaoTextosSegmentos(xBase, yBase, 2)
    }

    override fun angulosTextosArmaduraPositivaPrincipalFinal(): List<Float> {
        return armaduraPositivaPrincipal.barraFinalSuperior.angulosTextosSegmentos(2)
    }
