package br.com.gomes.moreira.guilherme.tcc.escadaslongitudinais.escadalongitudinal.Desenho.TipologiaA
...
class PlantaTipologiaA : DesenhoPlanta(ESCADA) {
    ...
    override fun desenharPlanta(xBase: Float,
        ...
        //Inicial
        val xArmaduraPositivaPrincipalInicialSuperior = xBase + cobrimento
        val yArmaduraPositivaPrincipalInicialSuperior = yContorno + larguraTotal*0.15f

        //Final
        val xArmaduraPositivaPrincipalFinalSuperior = xBase + comprimentoTotal - cobrimento
        val yArmaduraPositivaPrincipalFinalSuperior = yContorno + larguraTotal*0.30f
        ...
        val xArmaduraPositivaSecundariaPatamarInicial = xBase + baseApoioEsquerdo + comprimentoPatamarInicial*0.35f
        val yArmaduraPositivaSecundariaPatamarInicial = yContorno + cobrimento
        ...
        val yArmaduraNegativaPatamarIntermediario = yContorno + larguraTotal*0.15f
        ...
        if(escada.numeroLances == DOIS_LANCES){
            ...
            //Final
            desenharArmaduraPositivaPrincipalFinalSuperior(xArmaduraPositivaPrincipalFinalSuperior, yArmaduraPositivaPrincipalFinalSuperior, canvas, armaduraPositivaPrincipalPaint)
            desenharTextoArmaduraPositivaPrincipalFinalSuperior(xArmaduraPositivaPrincipalFinalSuperior, yArmaduraPositivaPrincipalFinalSuperior, canvas, textoPaint)
        }
    ...
    //Final
    override fun desenharArmaduraPositivaPrincipalFinalSuperior(xBase: Float, yBase: Float, canvas: Canvas, paint: Paint) {
        val path = armaduraPositivaPrincipalFinalSuperiorPath(xBase, yBase)
        canvas.drawPath(path, paint)
    }

    override fun desenharTextoArmaduraPositivaPrincipalFinalSuperior(xBase: Float, yBase: Float, canvas: Canvas, paint: Paint) {
        val texto = textoArmaduraPositivaPrincipalFinalSuperior()
        val posicao = posicaoTextoArmaduraPositivaPrincipalFinalSuperior(xBase, yBase)
    ...
    override fun contornoPath(xBase: Float, yBase: Float): Path {
        ...
        val comprimentoPatamarIntermediario = comprimentoPatamarIntermediario
        val comprimentoTotalInterno = comprimentoPatamarInicial + comprimentoLance + comprimentoPatamarIntermediario
        ...
        contornoPath.apply{
            ...
            rLineTo(-comprimentoTotalInterno, 0f)
            rLineTo(0f, -largura)
            rMoveTo(comprimentoPatamarInicial, 0f)
            rLineTo(0f, largura)
    ...
    //Final
    override fun armaduraPositivaPrincipalFinalSuperiorPath(xBase: Float, yBase: Float): Path {
        return armaduraPositivaPrincipal.barraFinalSuperior.geometriaProjecaoHorizontalPath(xBase, yBase)
    }

    override fun textoArmaduraPositivaPrincipalFinalSuperior(): String {
        return  armaduraPositivaPrincipal.barraFinalSuperior.textoReduzido
    }

    override fun posicaoTextoArmaduraPositivaPrincipalFinalSuperior(xBase: Float, yBase: Float): PointF {
        return armaduraPositivaPrincipal.barraFinalSuperior.posicaoTextoPlanta(xBase, yBase)
    }
    ...
    override fun armaduraPositivaSecundariaPatamarInicialPath(xBase: Float, yBase: Float): Path {
        return armaduraPositivaSecundaria.barraPatamarInicial.geometriaProjecaoHorizontalPath(xBase, yBase, vertical = true)
    }

    override fun textoArmaduraPositivaSecundariaPatamarInicial(): String {
        return armaduraPositivaSecundaria.barraPatamarInicial.textoReduzido
    }

    override fun posicaoTextoArmaduraPositivaSecundariaPatamarInicial(xBase: Float, yBase: Float): PointF {
        return armaduraPositivaSecundaria.barraPatamarInicial.posicaoTextoPlanta(xBase, yBase, vertical = true)
    }
